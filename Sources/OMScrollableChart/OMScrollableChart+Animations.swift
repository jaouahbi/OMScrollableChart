...
//            if finished {
//                let lastPoint = RenderManager.shared.layers.flatMap({$0}).max(by: { $0.frame.origin.x <= $1.frame.origin.x})
...
//    }
    ...
    ///   - duration: duration
    /// - Returns: CAAnimation
    func animatePointsClearOpacity(duration: TimeInterval = 4.0) {
    ...
    /// - Returns: description
    internal func animationOpacity(_ layer: CALayer,
                                   fromValue: CGFloat = 0,
                                   toValue: CGFloat = 1.0,
    ...
    ///   - duration: duration description
    /// - Returns: description
    internal func animationWithFadeGroup(_ layer: CALayer,
                                         fromValue: CGFloat = 0,
                                         toValue: CGFloat = 1.0,
    ...
    ///   - duration: duration description
    /// - Returns: description
    internal func animationWithFade(_ layer: CALayer,
                                    fromValue: CGFloat = 0,
                                    toValue: CGFloat = 1.0,
                                    duration: TimeInterval = 0.4) -> CAAnimation
    {
    ...
    internal func animateOnRenderLayerSelection(_ render: BaseRender,
